...
using Framework.Test.Base.TestData;
...
namespace Framework.Test.Base
{
    ...
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        protected TResult UsingDbContext<TResult>(Func<FrameworkDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<FrameworkDbContext, Task<TResult>> func)
        {
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<FrameworkDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<FrameworkDbContext, Task<TResult>> func)
        {
            TResult result;
