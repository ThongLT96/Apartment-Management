...
using Framework.Services.Navigation;
...
using Framework.UI;
using Framework.UI.Assets;
using Framework.Views;
using DependencyResolver = Framework.Core.Dependency.DependencyResolver;
...
namespace Framework.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Framework";
