...
using Framework.Configuration.Tenants.Dto;
using Framework.Security;
using Framework.Storage;
using Framework.Timing;

namespace Framework.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !FrameworkConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
