...
using Framework.Configuration.Dto;
using Framework.Configuration.Host.Dto;
using Framework.EntityFrameworkCore;
using Framework.Identity;
using Framework.Install.Dto;
using Framework.Migrations.Seed;
using Framework.Migrations.Seed.Host;
...
namespace Framework.Install
{
    ...
    public class InstallAppService : FrameworkAppServiceBase, IInstallAppService
    {
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{FrameworkConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FrameworkConsts.ConnectionStringName}", constring);
        }
