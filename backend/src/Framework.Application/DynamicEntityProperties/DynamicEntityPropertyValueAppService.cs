...
using Framework.DynamicEntityPropertyValues.Dto;

namespace Framework.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : FrameworkAppServiceBase, IDynamicEntityPropertyValueAppService
    {
