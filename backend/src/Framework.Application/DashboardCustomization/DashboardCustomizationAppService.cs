...
using Framework.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Framework.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : FrameworkAppServiceBase, IDashboardCustomizationAppService
    {
