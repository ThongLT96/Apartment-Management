...
namespace Framework.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FrameworkServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Framework", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
