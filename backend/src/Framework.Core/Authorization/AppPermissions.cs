namespace Framework.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Peoples_Create = "Pages.Peoples.Create";
        public const string Pages_Peoples_Edit = "Pages.Peoples.Edit";
        public const string Pages_Peoples_Delete = "Pages.Peoples.Delete";

        //COMMON PERMISSIONS (FOR BOTH OF TENANTS AND HOST)

        //Apartment Service
        public const string Pages_Tenant_AService = "Pages.Tenant.AService";
        //public const string Pages_Tenant_AService_CreateApartmentService = "Pages.Tenant.AService.CreateApartmentService";
        //public const string Pages_Tenant_AService_DeleteApartmentService = "Pages.Tenant.AService.DeleteApartmentService";
        //public const string Pages_Tenant_AService_EditApartmentService = "Pages.Tenant.AService.EditApartmentService";


        //Apartment Management
        public const string Pages_Tenant_ApartmentManagement = "Pages.Tenant.ApartmentManagement";

        //Bill
        public const string Pages_Tenant_Bill = "Pages.Tenant.Bill";
        //public const string Pages_Tenant_Bill_CreateApartmentBill = "Pages.Tenant.Bill.CreateApartmentBill";
        //public const string Pages_Tenant_Bill_CreateServiceBill = "Pages.Tenant.Bill.CreateServiceBill";
        //public const string Pages_Tenant_Bill_EditApartmentBill = "Pages.Tenant.Bill.EditApartmentBill";
        //public const string Pages_Tenant_Bill_EditServiceBill = "Pages.Tenant.Bill.EditServiceBill";

        // Permission for Admin to dominate Manager :)
        public const string Pages_Administration_Users_ManageManagers = "Pages.Administration.Users.ManageManagers";
        ...
        public const string Pages_Administration_feedback = "Pages.Administration.feedback";
        public const string Pages_Administration_citizen_info = "Pages.Administration.citizen-info";
