...
namespace Framework.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            //Apartment Service
            var aService = pages.CreateChildPermission(AppPermissions.Pages_Tenant_AService, L("AService"));


            //aService.CreateChildPermission(AppPermissions.Pages_Tenant_AService_CreateApartmentService, L("CreateApartmentService"));
            //aService.CreateChildPermission(AppPermissions.Pages_Tenant_AService_DeleteApartmentService, L("DeleteApartmentService"));
            //aService.CreateChildPermission(AppPermissions.Pages_Tenant_AService_EditApartmentService, L("EditApartmentService"));

            //Apartment Management
            var apartmentManagement = pages.CreateChildPermission(AppPermissions.Pages_Tenant_ApartmentManagement, L("ApartmentManagement"));

            //Bill
            var bill = pages.CreateChildPermission(AppPermissions.Pages_Tenant_Bill, L("Bill"));


            //bill.CreateChildPermission(AppPermissions.Pages_Tenant_Bill_CreateApartmentBill, L("CreateApartmentBill"));
            //bill.CreateChildPermission(AppPermissions.Pages_Tenant_Bill_EditApartmentBill, L("EditApartmentBill"));
            //bill.CreateChildPermission(AppPermissions.Pages_Tenant_Bill_CreateServiceBill, L("CreateServiceBill"));
            //bill.CreateChildPermission(AppPermissions.Pages_Tenant_Bill_EditServiceBill, L("EditServiceBill"));
            ...
            users.CreateChildPermission(AppPermissions.Pages_Administration_Users_ManageManagers, L("ManageManagers"));
            //for Manager
            users.CreateChildPermission(AppPermissions.Pages_Administration_Users_Approve, L("ApprovingRegistedUser"));
            ...
            administration.CreateChildPermission(AppPermissions.Pages_Administration_apartment, L("apartment"));
            administration.CreateChildPermission(AppPermissions.Pages_Administration_feedback, L("feedback"));
            administration.CreateChildPermission(AppPermissions.Pages_Administration_citizen_info, L("citizen-info"));
