...
using Framework.MultiTenancy.Demo;
...
namespace Framework.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(FrameworkConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
