...
{
    public class StripeGatewayManager : FrameworkServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Framework";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + FrameworkConsts.Currency;
        }
        ...
        private async Task<StripeIdResponse> CreatePlanAsync(string planId, decimal amount, string interval, string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = FrameworkConsts.Currency
            });
