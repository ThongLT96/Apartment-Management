...
using Framework.Authorization.Ldap;
using Framework.Authorization.Roles;
using Framework.Authorization.Users;
using Framework.Chat;
using Framework.Configuration;
using Framework.DashboardCustomization.Definitions;
using Framework.Debugging;
using Framework.DynamicEntityProperties;
...
namespace Framework
{
    ...
    public class FrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FrameworkMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
