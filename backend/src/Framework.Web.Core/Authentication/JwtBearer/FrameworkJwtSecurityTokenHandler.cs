...
namespace Framework.Web.Authentication.JwtBearer
{
    public class FrameworkJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public FrameworkJwtSecurityTokenHandler()
        {
