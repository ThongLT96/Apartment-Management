...
namespace Framework.Web.Startup
{
    ...
    public class FrameworkWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FrameworkWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FrameworkWebMvcModule).GetAssembly());
        }
