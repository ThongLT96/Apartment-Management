...
using Framework.Web.Models.Account;
...
{
    public class AccountController : FrameworkControllerBase
    {
        ...
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "", string ss = "")
        {
            ...
            {
                throw new UserFriendlyException("Không hỗ trợ [Yêu cầu thay đổi mật khẩu ở lần đăng nhập kế tiếp]");
                /*
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null || user.PasswordResetCode.IsNullOrEmpty() || SimpleStringCipher.Instance.Decrypt(user.PasswordResetCode) != model.OTP)
            {
                //throw new UserFriendlyException(L("InvalidPasswordResetCode"), L("InvalidPasswordResetCode_Detail"));
                throw new UserFriendlyException("Có gì đó sai sai");
            }
