...
using Framework.EntityFrameworkCore.Repositories;

namespace Framework.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : FrameworkRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<FrameworkDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
