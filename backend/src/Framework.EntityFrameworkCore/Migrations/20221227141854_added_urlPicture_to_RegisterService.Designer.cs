...
namespace Framework.Migrations
{
    ...
    [Migration("20221227141854_added_urlPicture_to_RegisterService")]
    partial class added_urlPicture_to_RegisterService
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Framework.AService.ApartmentService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AbpApartmentServices");
                });

            modelBuilder.Entity("Framework.Admin.People", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Framework.ApartmentManagement.Apartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("StatusDeleted")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("AbpApartments");
                });

            modelBuilder.Entity("Framework.Authorization.Accounts.EmailAddressOTP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EmailAddressOTP");
                });

            modelBuilder.Entity("Framework.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Framework.Bill.ApartmentBill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("NewIndex")
                        .HasColumnType("bigint");

                    b.Property<long>("OldIndex")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbpApartmentBill");
                });

            modelBuilder.Entity("Framework.Bill.BillingInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("DayTrading")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("AbpBillingInformation");
                });

            modelBuilder.Entity("Framework.Bill.ServiceBill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Framework.Feedback.UserFeedBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Framework.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Framework.ServiceRegister.UserServiceRegister2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Framework.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Framework.Authorization.Users.User", null)
                        .WithMany("Claims")
